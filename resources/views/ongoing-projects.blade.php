            ...
            <div class='col-md-12 main-container' >
                <div class='top-margin-gallery hcenter col-xs-12'>
                   <div class='col-sm-2 col-xs-1'>
                    ...
                    <a href="/projects/ongoing" class='yellow-color col-sm-2 col-xs-12 utility-yellow-sub-menu fifteen-font-size '>ON<label class='regular-font bottom-border-line'>GOI</label>NG</label></a>
                    <a href="/projects/ready-to-occupy" class='blue-color col-sm-3 col-xs-12 utility-blue-sub-menu fifteen-font-size' style="text-align:center">READY TO OCCUPY</a>
            ...
            <div class='col-xs-12 projects-sub-container' style='display:none;padding:1px'>
                ...
                <div class='col-md-8 col-xs-12'>
                    <div class='col-xs-12 ongoing-projects-sub-container-specification'>
                        ...
                        <a href="/tour/360-2/flash/Oxoniya_Oxoniya 360.html" target="_blank" class='col-xs-6 projects-360-link' target="_blank">
                            Watch 360&deg; view
                        </a>
