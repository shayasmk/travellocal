@include('layouts.test-header')
        ...
        <div class="header">Floor Plans</div>
        <div class="container">
            <div class='col-md-12'>
               ...
               <div class='top-margin-gallery  hcenter col-xs-12'>
                    ...
                    <div class='gallery-container col-xs-8'>
                        ...
                        <div class='col-md-3 col-sm-6 col-xs-12' style='padding-top:15px'>
                          ...
                          ?>
                            <p>
                                <a class="group1 gallery-image-container col-xs-12" href='/uploads/album-floor-plans/<?php echo $image['image']; ?>'>
                                    <img class='col-md-12 top-margin-gallery-image-1' style="width:50%;" src='/uploads/album-floor-plans/<?php echo $image['image']; ?>' /> 
