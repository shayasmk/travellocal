               ...
               <div class='top-margin-gallery  hcenter col-xs-12'>
                    ...
                    <div class='gallery-container col-xs-8'>
                        ...
                        <div class='col-md-3 col-sm-6 col-xs-12' style='padding-top:15px'>
                          ...
                          ?>
                            <p>
                                <a class="group1 gallery-image-container col-xs-12" href='/uploads/album-file-images/<?php echo $image['image']; ?>'>
                                    <img class='col-md-12 top-margin-gallery-image-1' src='/uploads/album-file-images/<?php echo $image['image']; ?>' /> 
