            ...
            <div class='col-md-12 main-container' >
                <div class='top-margin-gallery hcenter col-xs-12'>
                   <div class='col-sm-2 col-xs-1'>
                    ...
                    <a href="/projects/completed" class='blue-color col-sm-3 col-xs-12 utility-red-sub-menu   fifteen-font-size '>CO<label class='regular-font bottom-border-line'>MPLE</label>TED</a>
                    <div class='col-sm-2 col-xs-1'>
