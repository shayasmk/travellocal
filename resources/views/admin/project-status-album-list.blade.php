...
<!--                            <button class='btn btn-success' type='button'>Edit</button> -->
                                <a href="/admin/delete-album/<?php echo $album['id'] ?>" class='btn btn-danger' type='button'>Delete</a>
                            </div>
                            <?php
                            }
                            else
                            ...
                            <div class='hundred-percent hcenter'>
<!--                            <button class='btn btn-success' type='button'>Edit</button> -->
                                <a href="/admin/delete-album/<?php echo $album['id'] ?>/status" class='btn btn-danger' type='button'>Delete</a>
                            </div>
                                <?php
                            }
                            ?>
