...
@include('layouts.header')
        ...
        <section class="content " >
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <img class='hundred-percent' src='/uploads/album-floor-plans/<?php echo $img['image']; ?> ' />
                    <br/>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        {!! Form::open(['url' => 'admin/add-floor-plans/'.$data['id'], 'method' => 'post', 'class' => 'form-horizontal', 'role' => 'form', 'id' => 'disclaimer-form', 'files'=>true]) !!}
